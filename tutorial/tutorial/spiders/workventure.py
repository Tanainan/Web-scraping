...
class JobSpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        driver.get('https://www.workventure.com/jobs')
        link_elements = driver.find_elements_by_xpath('/html/body/div/div[1]/div/main/div[2]/div/div[2]/div[2]/div/div[4]/div[*]/div[2]/div[1]/div[3]/div/button')
    ...
    def parse_item(self, response):
        ...
        job_name = response.xpath('//*[contains(concat( " ", @class, " " ), concat( " ", "jobdescription__jobtitle", " " ))]').getall()
