...
class JobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        driver.get('https://www.techstarthailand.com/jobSearch/searchJob?employmentType=&experience=&keywords=&categories=&informations=&transportation=false&location=&provinces=&current=2&email=')
        link_elements = driver.find_elements_by_xpath('/html/body/div[2]/div[1]/div[*]/a')
