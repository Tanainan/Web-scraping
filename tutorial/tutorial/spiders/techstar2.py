...
class JobSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        driver.get('https://www.techstarthailand.com/jobSearch/searchJob?employmentType=&experience=&keywords=&categories=&informations=&transportation=false&location=&provinces=&current=3&email=')
