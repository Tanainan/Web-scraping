...
class JobSpider(CrawlSpider):
    name = 'thaieasyjob'
    start_urls = [
        "https://www.thaieasyjob.com/search1_result.php"
    ]

    # Set up rule for linking another page
    rules = [
        # inside card
        Rule(LinkExtractor(restrict_xpaths='/html/body/div[1]/div[1]/table[*]/tbody/tr/td[1]/a[1]'),
            callback='parse_item',follow=True),
        # next button
        Rule(LinkExtractor(restrict_xpaths='/html/body/div[1]/div[1]/table[22]/tbody/tr/td/a[16]'),
            follow=True)
    ]

    def parse_item(self, response):
            
        job_name = response.xpath('/html/body/div[1]/div[1]/table[2]/tbody/tr[1]').getall()
        ...
        yield {
            'URL ': response.url,
            'Web name ': "https://www.thaieasyjob.com",
            'Date_scrapy ' : ti,
